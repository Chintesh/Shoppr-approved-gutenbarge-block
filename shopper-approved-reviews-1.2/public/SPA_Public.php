                        ...
                        <div class="spa_header_content">
                            <div class="spa_full_width">
                                <div class="spa_half_width">
                                    ...
                                    <h3><span class="bold"
                                              itemprop="ratingValue"><?php echo esc_html($reviews->average); ?> </span>Overall
                                        <span class="hidden-sm">Satisfaction</span> Rating</h3>
                                    <h5 class="white">Based on <span class="goldhighlight" itemprop="reviewCount"
                                                                     content="<?php echo esc_attr($reviews->review_count); ?>">
								        <b style="color:orange;"><?php echo esc_html($reviews->review_count); ?></b></span>
                                        <span class="hidden-lg hidden-md hidden-sm">Customer Ratings</span> <span
                                                class="hidden-xs">Ratings from Actual Customers</span>
                                    </h5>
                                </div>
                            </div>
                        </div>
